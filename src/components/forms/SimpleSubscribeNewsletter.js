...
const Input = tw.input`w-full sm:w-auto block sm:inline-block px-6 py-4 rounded bg-blue-600 tracking-wider font-bold border border-blue-600 focus:border-blue-300 focus:outline-none sm:rounded-r-none hover:bg-blue-500 transition duration-300 text-gray-200`
